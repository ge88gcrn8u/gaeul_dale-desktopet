...
- **性格特点**：This squirrel character has a calm and thoughtful nature. Like the name Gaeul (meaning Autumn), it carries a peaceful, mature, and mentally strong atmosphere. #CALM #THOUGHTFUL #SQUIRREL #AUTUMN (https://linefriends.com/en/characters-list/ip-minive-minini?utm_source=chatgpt.com)
...
- 👁️ **wink**：眼皮缓缓盖下 → 闭合休息 → 缓缓睁开（约 1 秒），闭合时有睫毛弧线，睁眼时完全隐形
